  ...
  return (
    <div className=" relative   w-full flex flex-col h-screen bg-gray-100">
      ...
      <div className="flex justify-between items-center p-2 px-4 bg-white shadow-md">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className='switch relative flex flex-row gap-3 w-7 items-center '>
            ...
            <Link  to={"/"} className="bg-black/5 p-2 rounded-full hover:bg-black/80 hover:text-white text-black">
      ...
      <div className="bg-black text-white p-4 text-center flex items-center justify-between text-sm">
        <span>&copy; {new Date().getFullYear()} Alenbeza Charity. All Rights Reserved.</span>
